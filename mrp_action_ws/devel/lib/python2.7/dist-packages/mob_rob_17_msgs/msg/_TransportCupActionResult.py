...
"""autogenerated by genpy from mob_rob_17_msgs/TransportCupActionResult.msg. Do not edit."""
import sys
...
class TransportCupActionResult(genpy.Message):
  _md5sum = "076d66d2bf30b91604eb6f6b63cce621"
  _type = "mob_rob_17_msgs/TransportCupActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','mob_rob_17_msgs/TransportCupResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TransportCupActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = mob_rob_17_msgs.msg.TransportCupResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = mob_rob_17_msgs.msg.TransportCupResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_BH().pack(_x.result.robot_id, _x.result.result_code))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.robot_id, _x.result.result_code,) = _get_struct_BH().unpack(str[start:end])
      return self
