...
"""autogenerated by genpy from mob_rob_17_msgs/MotionExecutorActionResult.msg. Do not edit."""
import sys
...
class MotionExecutorActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "mob_rob_17_msgs/MotionExecutorActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','mob_rob_17_msgs/MotionExecutorResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MotionExecutorActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = mob_rob_17_msgs.msg.MotionExecutorResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = mob_rob_17_msgs.msg.MotionExecutorResult()
