...
"""autogenerated by genpy from mob_rob_17_msgs/AcceptCupActionResult.msg. Do not edit."""
import sys
...
class AcceptCupActionResult(genpy.Message):
  _md5sum = "b1e2eeea28ea28d919e81af99fd70383"
  _type = "mob_rob_17_msgs/AcceptCupActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','mob_rob_17_msgs/AcceptCupResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AcceptCupActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = mob_rob_17_msgs.msg.AcceptCupResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = mob_rob_17_msgs.msg.AcceptCupResult()
