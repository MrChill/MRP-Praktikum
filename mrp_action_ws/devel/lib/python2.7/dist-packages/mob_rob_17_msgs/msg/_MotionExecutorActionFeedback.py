...
"""autogenerated by genpy from mob_rob_17_msgs/MotionExecutorActionFeedback.msg. Do not edit."""
import sys
...
class MotionExecutorActionFeedback(genpy.Message):
  _md5sum = "99eff65d7d7ea548572edff08e1d4324"
  _type = "mob_rob_17_msgs/MotionExecutorActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','mob_rob_17_msgs/MotionExecutorFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MotionExecutorActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = mob_rob_17_msgs.msg.MotionExecutorFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = mob_rob_17_msgs.msg.MotionExecutorFeedback()
