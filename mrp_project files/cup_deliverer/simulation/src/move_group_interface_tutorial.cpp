...
int main(int argc, char **argv)
{
  ...
  moveit::planning_interface::MoveGroup::Plan trail_traj;
  bool success = group.plan(trail_traj);
  ...
  if (1)
  {
    ...
    display_trajectory.trajectory_start = trail_traj.start_state_;
    display_trajectory.trajectory.push_back(trail_traj.trajectory_);
